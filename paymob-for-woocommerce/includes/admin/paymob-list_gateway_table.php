...
class Paymob_List_Gateways {
	...
	public static function paymob_list_gateways_table( $gateway ) {
		...
		$row_html .= '<td data-label="Enable / Disable"><input type="checkbox" class="enable-checkbox" data-gateway-id="' . $gateway_id . '" data-integration-id="' . $integration_id . '" ' . $checked . ' /></td>';
